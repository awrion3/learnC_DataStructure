#ifndef __SEARCH_B_T_H__
#define __SEARCH_B_T_H__
//연결 리스트 기반 트리 구현
...
///이진 탐색 트리 삭제 관련 추가///
BTreeNode* RemoveLeftSubTree(BTreeNode* bt);	//가리키는 노드의 왼쪽 자식 노드 트리에서 제거
BTreeNode* RemoveRightSubTree(BTreeNode* bt);	//가리키는 노드의 오른쪽 자식 노드 트리에서 제거

void ChangeLeftSubTree(BTreeNode* main, BTreeNode* sub);		//왼쪽 자식 노드를 교체
void ChangeRightSubTree(BTreeNode* main, BTreeNode* sub);		//오른쪽 자식 노드를 교체
#endif